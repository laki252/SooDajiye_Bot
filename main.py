...
BOT_TOKEN = "8303813448:AAEVDY4a5fzP7pT-Yq-yPfdkzU0EsO87Z1c"
...
telebot_bot = telebot.TeleBot(BOT_TOKEN)
flask_app = Flask(__name__)
pyro_client = Client("video_downloader_bot", api_id=API_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
            ...
            if audio_path:
                try:
                    ...
                    await client.send_audio(
                        ...
                        performer="Powered by SooDajiye Bot"
                    )
                except:
                    pass
